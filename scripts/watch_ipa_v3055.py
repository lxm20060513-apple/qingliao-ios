#!/usr/bin/env python3
"""Watch CI (SHA 47d190b) → download built IPA (release asset) for 轻聊 v3.0.55."""
import sys, time, json, os, zipfile, plistlib, urllib.request, re, subprocess, hashlib
REPO="lxm20060513-svg/qingliao-ios"; SHA="47d190b"
OUT="/opt/data/qingliao-3.0.55-unsigned.ipa"; GIT_CWD="/opt/data/qingliao_ios"
def get_token():
                ...
                if rc=="success":
                    ...
                    for a2 in range(6):
                        try:
                            ...
                            print("  dl retry %d err %s"%(a2,type(e).__name__)); time.sleep(5)
                    if raw is None: print("DOWNLOAD FAILED"); sys.exit(1)
