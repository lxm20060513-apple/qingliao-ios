#!/usr/bin/env python3
"""Watch CI (SHA d4de743) → download built IPA (release asset) for 轻聊 v3.0.57."""
import sys, time, json, os, zipfile, plistlib, urllib.request, re, subprocess, hashlib
REPO="lxm20060513-svg/qingliao-ios"; SHA="d4de743"
OUT="/opt/data/qingliao-3.0.57-unsigned.ipa"; GIT_CWD="/opt/data/qingliao_ios"; WANT="3.0.57"
def get_token():
